    ...
    <div style={{ paddingTop: "64px", minHeight: "100vh" }}>
      ...
      <section style={{ padding: "80px 48px 64px", borderBottom: "1px solid rgba(174,0,255,0.3)" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          ...
          <p style={{ marginTop: 20, fontSize: "0.9rem", color: "#6b6b6b", maxWidth: 500, lineHeight: 1.7 }}>
      ...
      <section style={{ padding: "80px 48px 120px" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1.6fr", gap: 80, alignItems: "start" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 32 }}>
            ...
            <div style={{ padding: "24px", background: "#111", border: "1px solid rgba(174,0,255,0.2)", borderRadius: "8px" }}>
              ...
              {[
                ...
                <div key={text} style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 10 }}>
                  ...
                  <span style={{ fontSize: "0.78rem", color: "#aaa", fontFamily: "'DM Mono', monospace" }}>{text}</span>
                </div>
              ))}
            </div>
              ...
              {[
                ...
                <div key={label} style={{ display: "flex", alignItems: "center", gap: 16 }}>
                  ...
                  <div>
                    ...
                    <div style={{ fontSize: "0.82rem", color: "azure" }}>{value}</div>
                  </div>
                </div>
              ))}
            </div>
          ...
          <div style={{ background: "#111", border: "1px solid rgba(255,255,255,0.06)", borderRadius: "12px", padding: "48px" }}>
            {status === "sent" ? (
              ...
              <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 20 }}>
                <div>
                  <div style={{ fontSize: "0.65rem", color: "#ae00ff", textTransform: "uppercase", letterSpacing: "0.1em", marginBottom: 16, fontFamily: "'DM Mono', monospace" }}>
                    Envie uma mensagem
                  </div>
                  <p style={{ fontSize: "0.8rem", color: "#555", marginBottom: 24, lineHeight: 1.6 }}>
