  ...
  return (
    <div style={{ paddingTop: "64px" }}>
      ...
      <section className="grid-bg" style={{
        ...
        justifyContent: "center", padding: "40px clamp(20px, 5vw, 48px)",
        position: "relative", overflow: "hidden",
      }}>
        <div style={{ position: "absolute", top: "20%", right: "10%", width: "clamp(200px, 40vw, 400px)", height: "clamp(200px, 40vw, 400px)", background: "radial-gradient(circle, rgba(174,0,255,0.07) 0%, transparent 70%)", borderRadius: "50%", pointerEvents: "none" }} />
        <div style={{ position: "absolute", bottom: "20%", left: "5%", width: "clamp(150px, 30vw, 300px)", height: "clamp(150px, 30vw, 300px)", background: "radial-gradient(circle, rgba(173,110,246,0.08) 0%, transparent 70%)", borderRadius: "50%", pointerEvents: "none" }} />
        ...
        <div style={{ maxWidth: 900, opacity: 0, animation: "fadeUp 0.8s ease 0.2s forwards" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 28 }}>
            ...
            <span style={{ fontSize: "clamp(0.6rem, 2vw, 0.7rem)", color: "#6b6b6b", letterSpacing: "0.2em", textTransform: "uppercase", fontFamily: "DM Mono, monospace" }}>
          ...
          <h1 style={{
            ...
            fontSize: "clamp(2.2rem, 8vw, 5.5rem)", lineHeight: 1,
            letterSpacing: "-0.04em", color: "azure", marginBottom: 24,
          }}>
            Desenvolvedor<br />
          ...
          <p style={{
            maxWidth: 560, fontSize: "clamp(0.8rem, 2vw, 1rem)",
            lineHeight: 1.75, color: "#8a8a8a",
            fontFamily: "'DM Mono', monospace", marginBottom: 36,
          }}>
          ...
          <div className="hero-ctas" style={{ display: "flex", gap: 12, flexWrap: "wrap", marginBottom: 40 }}>
            <Link href="/projetos" style={{
              ...
              fontSize: "clamp(0.7rem, 2vw, 0.78rem)", fontWeight: 500, letterSpacing: "0.08em",
            ...
            <a href="/resume.pdf" style={{
              ...
              fontFamily: "'DM Mono', monospace", fontSize: "clamp(0.7rem, 2vw, 0.78rem)",
          ...
          {/* Info row */}
          <div className="hero-info-row" style={{ display: "flex", alignItems: "center", gap: 20, flexWrap: "wrap" }}>
            <a href="https://github.com/PauloRojas18" target="_blank" rel="noopener noreferrer" style={{ display: "flex", alignItems: "center", gap: 6, color: "#555", fontSize: "0.75rem", textDecoration: "none", fontFamily: "'DM Mono', monospace", transition: "color 0.2s" }}
              onMouseEnter={e => (e.currentTarget.style.color = "#ae00ff")}
              onMouseLeave={e => (e.currentTarget.style.color = "#555")}
            >
              <Github size={14} /> GitHub
            </a>
            <a href="https://www.linkedin.com/in/paulo-rojas-b7b77a3a1/" target="_blank" rel="noopener noreferrer" style={{ display: "flex", alignItems: "center", gap: 6, color: "#555", fontSize: "0.75rem", textDecoration: "none", fontFamily: "'DM Mono', monospace", transition: "color 0.2s" }}
              onMouseEnter={e => (e.currentTarget.style.color = "#ae00ff")}
              onMouseLeave={e => (e.currentTarget.style.color = "#555")}
            >
              <Linkedin size={14} /> LinkedIn
            </a>
            <span className="hero-info-divider" style={{ width: 1, height: 16, background: "#2a2a2a" }} />
            <span style={{ display: "flex", alignItems: "center", gap: 5, color: "#444", fontSize: "clamp(0.65rem, 1.5vw, 0.72rem)", fontFamily: "'DM Mono', monospace" }}><MapPin size={12} /> Campo Grande, MS</span>
            <span style={{ display: "flex", alignItems: "center", gap: 5, color: "#444", fontSize: "clamp(0.65rem, 1.5vw, 0.72rem)", fontFamily: "'DM Mono', monospace" }}><Briefcase size={12} /> CLT · Freelance · Remoto</span>
            <span style={{ display: "flex", alignItems: "center", gap: 5, color: "#444", fontSize: "clamp(0.65rem, 1.5vw, 0.72rem)", fontFamily: "'DM Mono', monospace" }}><Clock size={12} /> Turno tarde</span>
          </div>
        </div>
      </section>

      {/* ── RESUMO RÁPIDO ────────────────────────────────────────── */}
      <section style={{ padding: "64px clamp(20px,5vw,48px)", background: "#0a0a0a", borderTop: "1px solid rgba(174,0,255,0.15)", borderBottom: "1px solid rgba(174,0,255,0.15)" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <div className="quick-resume-grid" style={{ display: "grid", gridTemplateColumns: "1fr 2fr", gap: 64, alignItems: "center" }}>
            <div>
            ...
            <div className="quick-resume-cards" style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: 16 }}>
              {[
                ...
                <div key={i} style={{ padding: "16px 20px", background: "#111", border: "1px solid rgba(255,255,255,0.05)", borderRadius: "6px" }}>
                  <div style={{ fontSize: "0.6rem", color: "#ae00ff", textTransform: "uppercase", letterSpacing: "0.12em", marginBottom: 6 }}>{item.label}</div>
                  <div style={{ fontSize: "clamp(0.7rem, 1.5vw, 0.78rem)", color: "#ccc", fontFamily: "'DM Mono', monospace", lineHeight: 1.5 }}>{item.value}</div>
                </div>
              ))}
            </div>
          </div>
      ...
      <div style={{ borderTop: "1px solid rgba(255,255,255,0.04)", borderBottom: "1px solid rgba(255,255,255,0.04)", padding: "14px 0", overflow: "hidden", background: "#111" }}>
        <div className="animate-marquee" style={{ display: "flex", gap: 48, width: "max-content" }}>
          {[...stack, ...stack].map((t, i) => (
            <span key={i} style={{
              fontFamily: "'Poppins', sans-serif", fontWeight: 700, fontSize: "clamp(0.7rem, 2vw, 0.85rem)",
      ...
      {/* ── PROJETOS ─────────────────────────────────────────────── */}
      <section style={{ padding: "80px clamp(20px,5vw,48px)" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", marginBottom: 56, flexWrap: "wrap", gap: 16 }}>
            <div>
              ...
              <h2 style={{ fontFamily: "'Poppins', sans-serif", fontWeight: 800, fontSize: "clamp(1.6rem, 5vw, 3.5rem)", color: "azure", marginTop: 8, letterSpacing: "-0.03em" }}>
                Sistemas Reais
              </h2>
            </div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: 24 }}>
            {projetos.map((p) => (
              <div key={p.num} className="card-hover" style={{
                ...
                borderRadius: "8px", padding: "clamp(20px, 4vw, 28px)", display: "flex", flexDirection: "column",
                position: "relative", overflow: "hidden",
              }}>
                ...
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 16 }}>
                  ...
                  <span style={{ fontSize: "0.6rem", color: "#ae00ff", border: "1px solid #ae00ff33", padding: "3px 10px", borderRadius: "999px", fontFamily: "'DM Mono', monospace", display: "flex", alignItems: "center", gap: 6 }}>
                    {p.badge}
                ...
                <div style={{ display: "flex", flexWrap: "wrap", gap: 6, marginTop: "auto", paddingBottom: 16 }}>
                  {p.tags.map(tag => (
                    <span key={tag} style={{ padding: "3px 10px", border: "1px solid #333", borderRadius: "100px", fontSize: "0.62rem", color: "#555", fontFamily: "'DM Mono', monospace" }}>{tag}</span>
                  ))}
                </div>

                <div style={{ display: "flex", gap: 16, borderTop: "1px solid rgba(255,255,255,0.05)", paddingTop: 16 }}>
                  <a href={p.github} target="_blank" rel="noopener noreferrer" style={{ display: "flex", alignItems: "center", gap: 6, color: "#6b6b6b", fontSize: "0.7rem", textDecoration: "none", fontFamily: "'DM Mono', monospace", transition: "color 0.2s" }}
                  ...
                  {p.live && (
                    <a href={p.live} target="_blank" rel="noopener noreferrer" style={{ display: "flex", alignItems: "center", gap: 6, color: "#ae00ff", fontSize: "0.7rem", textDecoration: "none", fontFamily: "'DM Mono', monospace" }}>
      ...
      {/* ── SERVIÇOS ─────────────────────────────────────────────── */}
      <section style={{ padding: "80px clamp(20px,5vw,48px) 120px", background: "#0d0d0d" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <span style={{ fontSize: "0.65rem", color: "#6b6b6b", textTransform: "uppercase", letterSpacing: "0.2em" }}>— serviços</span>
          <h2 style={{ fontFamily: "'Poppins', sans-serif", fontWeight: 800, fontSize: "clamp(1.6rem, 5vw, 3rem)", color: "azure", marginTop: 8, letterSpacing: "-0.03em", marginBottom: 48 }}>
            O que eu faço
          </h2>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: 1 }}>
            {servicos.map((s, i) => (
              <div key={i} style={{ padding: "clamp(24px, 4vw, 36px) clamp(20px, 3vw, 28px)", borderBottom: "1px solid rgba(255,255,255,0.05)", borderRight: "1px solid rgba(255,255,255,0.05)", transition: "background 0.2s ease" }}
              ...
              >
                ...
                <h3 style={{ fontFamily: "'Poppins', sans-serif", fontWeight: 700, fontSize: "1rem", color: "azure", marginBottom: 10 }}>{s.title}</h3>
                <p style={{ fontSize: "clamp(0.72rem, 1.5vw, 0.78rem)", color: "#6b6b6b", lineHeight: 1.6 }}>{s.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* ── CTA FINAL ────────────────────────────────────────────── */}
      <section className="grid-bg" style={{ padding: "100px clamp(20px,5vw,48px)", textAlign: "center", borderTop: "1px solid rgba(174,0,255,0.2)" }}>
        <div style={{ maxWidth: 700, margin: "0 auto" }}>
          <span style={{ fontSize: "0.65rem", color: "#ae00ff", textTransform: "uppercase", letterSpacing: "0.2em" }}>— próximo passo</span>
          <h2 style={{ fontFamily: "'Poppins', sans-serif", fontWeight: 800, fontSize: "clamp(1.8rem, 5vw, 3rem)", color: "azure", marginTop: 12, letterSpacing: "-0.03em", marginBottom: 20 }}>
            Vamos conversar?
          </h2>
